...
export async function fetchInitialState() {
  const [temasR, hitosR, expR, respR, comR, actR, docR, profR] = await Promise.all([
  ...
  for (const r of [temasR, hitosR, expR, respR, comR, actR, docR, profR]) must(r);
  ...
  return { temas, expedientes, responsables, documentos, usuarios };
}
